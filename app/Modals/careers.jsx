              ...
              <div className=" flex flex-col gap-5">
                <div className="flex items-center gap-2">
                  <img
                    ...
                    className="w-[50px] rounded-xl object-contain bg-black"
                  />
                  <div className="text-lg font-bold">{data[0]?.fullname}</div>
                </div>
                <div className="flex sm:flex-row flex-col gap-4 w-full">
                  <div className="w-full flex gap-4  flex-col">
                    ...
                    <div className="font-semibold flex flex-col gap-1">
                      <div>
                        What is your overall experience with Grovyo application?
                      </div>
                      <div>{data[0]?.experienceUsingGrovyo}</div>
                    </div>
                    <div className="font-semibold flex flex-col gap-1">
                      <div>
                        What are your short-term and long-term career goals
                      </div>
                      <div>{data[0]?.careerPlans}</div>
                    </div>
                  </div>
                  ...
                  <div className="w-full flex gap-4  flex-col">
                    ...
                    <div className="font-semibold flex flex-col gap-1">
                      <div>Why you are great for this job ?</div>
                      <div>{data[0]?.message}</div>
                    </div>
                    <div className="font-semibold flex flex-col gap-1">
                      <div>What is Grovyo from your perspective?</div>
                      <div>{data[0]?.perspective}</div>
                    </div>
                    <div className="font-semibold flex flex-col gap-1">
                      <div>Tell us your achievements</div>
                      <div>{data[0]?.yourAchievements}</div>
                    </div>
                  </div>
                </div>
              </div>
