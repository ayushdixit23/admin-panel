          ...
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div className="flex gap-6 items-center order-2">
              ...
              <div className="flex justify-center items-center gap-2">
                ...
                <div
                  onClick={() => logout()}
                  className="text-xl hidden sm:block text-red-600"
                >
                  <CiLogout />
                </div>
                <div className="text-2xl sm:hidden block z-40">
                  {open ? (
                    ...
                    <RiMenu3Fill onClick={() => setOpen(!open)} />
                  )}
                </div>
              </div>
            </div>
            <div
              className="hidden justify-between items-center sm:flex sm:w-auto order-1"
              id="mobile-menu-2"
            >
              <ul className="flex flex-col font-medium sm:flex-row lg:space-x-8 sm:mt-0">
                <li>
                  <Link
                    href="/main/dashboard"
                    className="block py-2 pr-4 pl-3 text-black dark:text-white  rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 "
                    aria-current="page"
                  >
                    Dashboard
                  </Link>
                ...
                <Link href={"/main/bank"}>
                  <div className="block py-2 pr-4 pl-3 text-black dark:text-white border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0  lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">
                    Bank
                  </div>
                </Link>
