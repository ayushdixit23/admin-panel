      ...
      <div className="fixed inset-0  flex items-center justify-center ">
          <div className="p-6 rounded-lg bg-[#273142] shadow-md">
              ...
              <div className="flex justify-end">
                  <button
                      onClick={onClose}
                      className=" rounded px-4 py-2 mr-2"
                  >
                      Cancel
                  </button>
                  <button
...
const page = () => {
  ...
  return <>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="text-gray-900 dark:text-white">
                <div className="text-base font-semibold">{d?.fullname}</div>
                <div className="text-sm text-gray-500">{d?.password ? d?.password : "undefined"}</div>
              </div>
            </div>
            <div>
              <GoPlus className="text-2xl text-blue-600 cursor-pointer hover:text-blue-700 transition" onClick={() => savetoLocalStorage(d)} />
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="w-full relative mt-8">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div className="text-gray-900 dark:text-white">
              <div className="text-base font-semibold">{selectedCom?.title}</div>
    ...
    <div className="flex justify-center items-center gap-3">
      <Link className="bg-blue-500 text-white p-2 px-5 text-sm rounded-xl" href={"/main/user?mediaType=video"}>
      Create Video Post
      </Link>
      <Link className="bg-blue-500 text-white p-2 px-5 text-sm rounded-xl" href={"/main/user?mediaType=image"}>
      Create Image Post
      </Link>
      ...
      {
        mediaType && <CreatePost id={selectedUser.id} comid={selectedCom.id} mediaType={mediaType} />
      }
    </div>
  </>;
};
