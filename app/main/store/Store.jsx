  ...
  const storeData = async () => {
    try {
      ...
      if (res.data.success) {
        setCount({
          ...count,
          totalStore: res.data.totalStore,
          totalRequests: res.data.totalRequests,
          totalPendingStore: res.data.totalPendingStore,
      ...
      <div className="flex flex-col mt-2 p-3 py-6 w-full">
        ...
        <div className="mt-4 dark:bg-[#101010] light:text-black rounded-xl p-4">
          ...
          <div className="mt-4">
            <div className="overflow-auto no-scrollbar">
              ...
              {data.product?.length > postPerPage && (
                <Pagination
                  postPerPage={postPerPage}
                  setCurrentPage={setCurrentPage}
                  currentPage={currentPage}
        ...
        <div className="mt-4 dark:bg-[#101010] light:text-black rounded-xl p-4">
          ...
          <div className="mt-4">
            <div className="overflow-auto no-scrollbar">
              <OrderFetch
                data={postperOrderData}
                setOpen3={setOpen3}
                url={data.purl}
              />
              {data.order?.length > postPerPage && (
                <Pagination
                  postPerPage={postPerPage}
                  setCurrentPage={setCurrentPage}
                  currentPage={currentPage}
